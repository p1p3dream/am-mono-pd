...
variable "config" {
  description = "Local config for the instance."
  type = object({
    vars = object({
...
variable "subnet_id" {
  description = "The subnet id to deploy the instance to."
  type        = string
}
...
variable "vpc_security_group_ids" {
  description = "The security group ids to apply to the instance."
  type        = list(string)
}
