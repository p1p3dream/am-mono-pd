...
create index idx_ad_df_rental_avm_attomid
	on ad_df_rental_avm (attomid);

create index idx_ad_df_rental_avm_valuation_date
	on ad_df_rental_avm (valuation_date);
