...
create table ad_df_listing_2 (
	...
	mls_listing_city                       text,
	mls_listing_state                      text,
	mls_listing_zip                        text,
	mls_listing_county_fips                text,
	mls_number                             text,
	mls_source                             text,
	listing_status                         text,
	mls_sold_date                          date,
...
create index ad_df_listing_attom_id
	on ad_df_listing_2 (attom_id);

create index ad_df_listing_mls_listing_id
	on ad_df_listing_2 (mls_listing_id);

create index ad_df_listing_status_change_date
	on ad_df_listing_2 (status_change_date);

create index ad_df_mls_property_type
	on ad_df_listing_2 (mls_property_type, mls_property_sub_type);

create index ad_df_attom_property_type
	on ad_df_listing_2 (attom_property_type, attom_property_sub_type);

insert into ad_df_listing_2
select * from ad_df_listing;

-- +migrate Down

drop table ad_df_listing_2;
